...
import { ShieldCheck, BarChart2, Zap, Star } from 'lucide-react';
...
const TrustLogo: React.FC<{name: string}> = ({ name }) => (
    <div className="text-gray-500 font-bold text-2xl tracking-widest opacity-60 grayscale hover:opacity-100 hover:grayscale-0 transition-all">
        {name}
    </div>
);
        ...
        <SectionWrapper className="bg-white/5">
             <div className="max-w-6xl mx-auto text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                    <div className="text-center">
                     ...
                     <div className="text-center">
                        ...
                        <p className="text-gray-400 mt-2">Tracked Monthly</p>
                    </div>
                     <div className="text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                 ...
                 {/* Trust Logos */}
                <div className="mt-20 flex justify-center items-center gap-12 flex-wrap">
                    <TrustLogo name="FINNOVATE" />
                    <TrustLogo name="FORBES" />
                    <TrustLogo name="TECHCRUNCH" />
                    <TrustLogo name="WIRED" />
                </div>
             </div>
        </SectionWrapper>
