...
const Transactions: React.FC<TransactionsProps> = ({ transactions, addTransaction, updateTransaction, deleteTransaction, addMultipleTransactions, isMobile }) => {
    ...
    <div className="space-y-8">
      <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center">
        ...
        <div className="flex gap-2 self-end sm:self-auto">
            ...
            <Button onClick={handleImportClick} variant="secondary" size="md">
                <Upload className="mr-2 h-4 w-4" />
                Import
            </Button>
            <Button onClick={() => handleModalOpen()} size="md">
