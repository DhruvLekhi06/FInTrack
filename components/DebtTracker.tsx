...
const DebtTracker: React.FC<DebtTrackerProps> = ({ debts, addDebt, updateDebt, deleteDebt }) => {
  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-[var(--text-primary)]">{t('debts.title')}</h1>
        <Button onClick={() => handleModalOpen(null)}>
